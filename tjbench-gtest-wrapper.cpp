...
#if defined(ANDROID)
    base::FilePath target_path(FILE_PATH_LITERAL("/sdcard/testout_tile.ppm"));
#else
    base::FilePath target_path;
    ASSERT_TRUE(base::PathService::Get(base::DIR_CURRENT, &target_path));
...
#if defined(ANDROID)
  base::FilePath test_image_path(FILE_PATH_LITERAL("/sdcard"));
#else
  base::FilePath test_image_path;
  ASSERT_TRUE(base::PathService::Get(base::DIR_CURRENT, &test_image_path));
#endif
...
#if defined(ANDROID)
    base::FilePath target_path(FILE_PATH_LITERAL("/sdcard/testout_tilem.ppm"));
#else
    base::FilePath target_path;
    ASSERT_TRUE(base::PathService::Get(base::DIR_CURRENT, &target_path));
